...
## Особенности
• **Проект на .NET 9** — использование актуальных возможностей языка и платформы.
• **Управление обучением** — создание курсов, уроков и вопросов с поддержкой иерархической структуры (дерево курсов).
• **Автоматизированное тестирование** — проверка ответов студентов в реальном времени с начислением баллов.
...
• **Event-Driven** — асинхронное взаимодействие через очереди сообщений (RabbitMQ).
• **Паттерны проектирования** — CQRS (MediatR), Репозиторий, UnitOfWork, Фасад (Service Layer).
